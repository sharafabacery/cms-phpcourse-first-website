            ...
            <div class="panel-heading">
                <div class="row">
                  ...
                  <div class='huge'>
                    ...
                    <?php echo $post_count=record_count("posts");?>
                  </div>
                        <div>Posts</div>
                    </div>
                </div>
...
<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['data', 'Count'],
          <?php
          $elements_text=['all posts','Active Post','Draft post','Categories','Users(admin)','Users(subscriber)','Comments(approved)','Comments(unapproved)'];
          $elements_count=[$post_count,$post_count-$post_draft_count,$post_draft_count,$category_count,$users_count-$users_subscriber_count,$users_subscriber_count,$comment_count-$comment_unapproved_count,$comment_unapproved_count];
